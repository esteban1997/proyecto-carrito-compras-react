...
export const NavBar = () => {
  ...
  const cantidadCompras = () =>{
    console.log(listaCompras.reduce((total,item)=>total+item.cantidad*item.cantidad,0))
  }
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <NavLink className="nav-link active" aria-current="page" to="/carrito">Compras</NavLink>
            </li>
          </ul>
          <NavLink to="/">
